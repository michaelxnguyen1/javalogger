...
public class JavaLogger {
    ...
    public JavaLogger(String baseName, boolean addDateToBaseName) throws IOException {
        ...
        if (addDateToBaseName) {
            // LocalDate is a handy class for getting the current, local date
        ...
        try (BufferedReader configReader = new BufferedReader(
            ...
            logLevel = LogLevel.valueOf(levelString); // <<< nice!
        }
    }
    ...
    private final BufferedWriter logFile; // file and associated writer. why final?
}
